...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleUnsupportedType(
    ...
    public ResponseEntity<ApiErrorResponse> handleIndexingInProgress(
            DocumentIndexingInProgressException exception) {
    ...
    public ResponseEntity<ApiErrorResponse> handleValidation(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(
                        ApiErrorResponse.of(
                                "validation_failed", "The request payload is invalid", details));
    }
}
